...
const monthlySalesChart = (startMonth, startYear) => {
  let endMonth;
  let endYear;
  if (startMonth == 01) {
    endMonth = 12;
...
const topSalesChart = (month, year) => {
